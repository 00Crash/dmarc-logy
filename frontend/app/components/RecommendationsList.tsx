      ...
      <div className="flex items-center justify-between gap-4 border-b border-slate-100 p-5">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-xl font-black tracking-tight text-slate-950">Doporučení</h2>
            <p className="mt-1 text-sm font-medium text-slate-500">Kompaktní seznam úkolů podle SPF/DKIM/DMARC výsledků.</p>
          </div>
        </div>
